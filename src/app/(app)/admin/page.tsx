...
function UserDataModal({ user, token }: { user: UserType, token: string | null }) {
  ...
  useEffect(() => {
    async function fetchHistory() {
      ...
      console.log('fetch history for user');
      setLoading(true);
      try {
  ...
  console.log('UserDataModal ' + filteredHistory.length);
  return (
    <>
      ...
      <DialogContent className="max-w-6xl h-[90vh] flex flex-col">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="mt-4 font-semibold">No Nutrient History{filteredHistory.length}</p>
